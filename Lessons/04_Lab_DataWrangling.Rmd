...
NTL.phys.data.Tue.1990.1999 <-
  NTL.phys.data %>%
  filter(year4 %in% c(1990:1999)) %>%
  filter(lakename == "Tuesday Lake")

NTL.phys.data.Tue.1990.1999 <-droplevels(NTL.phys.data.Tue.1990.1999)
...
NTL.phys.data.July <-
  ...
  select(lakeid:year4, month, daynum:comments) %>%
  filter(month == 07)

NTL.phys.data.July <-droplevels(NTL.phys.data.July)
