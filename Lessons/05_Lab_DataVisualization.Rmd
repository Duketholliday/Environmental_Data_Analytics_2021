...
ggsave("Z:/ENV872/Environmental_Data_Analytics_2021/Output/Plot_text.jpg",Plot_text, height = 4, width = 6, units = "in", dpi = 300)
...
PeterPaul.chem.nutrients <- 
  read.csv("Z:/ENV872/Environmental_Data_Analytics_2021/Data/Processed/NTL-LTER_Lake_Chemistry_Nutrients_PeterPaul_Processed.csv", stringsAsFactors = TRUE)
EPAair <- read.csv("Z:/ENV872/Environmental_Data_Analytics_2021/Data/Processed/EPAair_O3_PM25_NC1718_Processed.csv", stringsAsFactors = TRUE)
...
temp.by.depth <- ggplot(PeterPaul.chem.nutrients)+
...
Air.plot <- ggplot(EPAair)+
  geom_point(aes(x = Ozone, y = PM2.5, color = SITE_LATITUDE), alpha = 0.5)+
  geom_smooth(aes(x = Ozone, y = PM2.5), method = lm)
print(Air.plot)
